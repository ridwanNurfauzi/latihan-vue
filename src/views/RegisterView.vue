<template>
    <div
        ...
        <div
            class="sm:w-[525px] flex-grow sm:grow-0 bg-gray-100 dark:bg-gray-700 bg-opacity-60 dark:bg-opacity-60 backdrop-blur-[2px] sm:backdrop-blur-sm transition-all sm:rounded-2xl sm:my-20 shadow-2xl px-7 flex">
